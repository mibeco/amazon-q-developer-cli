#!/usr/bin/env python3
"""
Amazon Q CLI Documentation Enhancement Script using Amazon Bedrock

This script enhances basic CLI documentation by:
1. Analyzing the codebase to extract detailed command information
2. Using Amazon Bedrock (Claude) to generate comprehensive, user-friendly documentation
3. Outputting enhanced Markdown files ready for mdBook processing

Usage:
  python enhance_docs_bedrock.py --input-dir docs/generated --code-dir . --output-dir docs/enhanced
"""
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description='Enhance CLI documentation using Amazon Bedrock')
    ...
    for file_name in os.listdir(args.input_dir):
        ...
        try:
            ...
            if enhanced_content:
                ...
                print(f"Error: Failed to generate enhanced documentation for {command_name}")
